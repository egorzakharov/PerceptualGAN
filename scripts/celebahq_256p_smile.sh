...
--train_img_A_path data/lists_hq/smile_train.txt \
--train_img_B_path data/lists_hq/not_smile_train.txt \
--test_img_A_path data/lists_hq/smile_test.txt \
--test_img_B_path data/lists_hq/not_smile_test.txt \
--input_transform flip,scale \
--experiment_name celebahq_256p_smile \
--batch_size 16 \
--img_size 256 \
--model_type cyclegan \
--kernel_size 4 \
