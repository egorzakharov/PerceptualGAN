...
--train_img_A_path data/lists_hq/blondhair_train.txt \
--train_img_B_path data/lists_hq/not_blondhair_train.txt \
--test_img_A_path data/lists_hq/blondhair_test.txt \
--test_img_B_path data/lists_hq/not_blondhair_test.txt \
--input_transform flip,scale \
--experiment_name celebahq_256p_blondhair \
--batch_size 16 \
--img_size 256 \
--model_type cyclegan \
--kernel_size 4 \
