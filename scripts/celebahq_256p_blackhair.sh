...
--train_img_A_path data/lists_hq/blackhair_train.txt \
--train_img_B_path data/lists_hq/not_blackhair_train.txt \
--test_img_A_path data/lists_hq/blackhair_test.txt \
--test_img_B_path data/lists_hq/not_blackhair_test.txt \
--input_transform flip,scale \
--experiment_name celebahq_256p_blackhair \
--batch_size 16 \
--img_size 256 \
--model_type cyclegan \
--kernel_size 4 \
